<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\phpstudy\WWW\php_web\public/../app/admin\view\index\employ.html";i:1561202171;s:60:"D:\phpstudy\WWW\php_web\app\admin\view\common\headerbar.html";i:1561083731;s:58:"D:\phpstudy\WWW\php_web\app\admin\view\common\sidebar.html";i:1561453611;}*/ ?>
<!doctype html>
<html lang="cn">
        ...
        <section id="main" class="column">
            ...
            <article class="module width_full" style="border:0;">
                <table class="layui-table" lay-size="sm" style="text-align:center;">
                    ...
                    <tbody>
                        <?php if(is_array($recruit) || $recruit instanceof \think\Collection || $recruit instanceof \think\Paginator): $i = 0; $__LIST__ = $recruit;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td><?php echo $item['hopedepart']; ?></td>
                            <td><?php echo $item['hopemoney']; ?></td>
                            <td><?php echo $item['phone']; ?></td>
                            <td><?php echo $item['content']; ?></td>

                            <td>
                                <button class="layui-btn layui-btn-sm layui-btn-normal"
                                    onclick="modify('<?php echo $item['no']; ?>')">录用
                                </button>

                                <button class="layui-btn layui-btn-sm layui-btn-danger"
                                    onclick="delete_('<?php echo $item['no']; ?>')">删除
                                </button>
                            </td>
                        </tr>
