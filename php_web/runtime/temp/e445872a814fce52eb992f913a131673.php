<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpstudy\WWW\php_web\public/../app/admin\view\index\depart_opt.html";i:1561272164;s:60:"D:\phpstudy\WWW\php_web\app\admin\view\common\headerbar.html";i:1561083731;s:58:"D:\phpstudy\WWW\php_web\app\admin\view\common\sidebar.html";i:1561453611;}*/ ?>
<!doctype html>
<html lang="cn">
        ...
        <section id="main" class="column">
            ...
            <article class="module width_full" style="border:0;">
                ...
                <table class="layui-table" lay-size="sm" style="text-align:center;">
                    ...
                    <tbody>
                        <?php if(is_array($depart) || $depart instanceof \think\Collection || $depart instanceof \think\Paginator): $i = 0; $__LIST__ = $depart;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td><?php echo $item['departid']; ?></td>
                            <td><?php echo $item['dname']; ?></td>
                            <td><?php echo $item['departsum']; ?></td>
                            <td><?php echo $item['manager']; ?></td>
                            <td><?php echo $item['pid']; ?></td>
                            <td>
                                <button class="layui-btn layui-btn-sm layui-btn-normal"
                                    onclick="modify('<?php echo $item['departid']; ?>')">修改
                                </button>

                                <button class="layui-btn layui-btn-sm layui-btn-danger"
                                    onclick="confirm('<?php echo $item['departid']; ?>')">删除
                                </button>
                            </td>
                        </tr>
