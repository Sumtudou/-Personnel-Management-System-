<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpstudy\WWW\php_web\public/../app/admin\view\index\reward_opt.html";i:1561362713;s:60:"D:\phpstudy\WWW\php_web\app\admin\view\common\headerbar.html";i:1561083731;s:58:"D:\phpstudy\WWW\php_web\app\admin\view\common\sidebar.html";i:1561453611;}*/ ?>
<!doctype html>
<html lang="cn">
        ...
        <section id="main" class="column">
            ...
            <article class="module width_full" style="border:0;">
                ...
                <table class="layui-table" lay-size="sm" style="text-align:center;">
                    ...
                    <tbody>
                        <?php if(is_array($reward) || $reward instanceof \think\Collection || $reward instanceof \think\Paginator): $i = 0; $__LIST__ = $reward;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <tr>
        ...
        function confirm(id) {
            ...
            layui.use('layer', function () {
                ...
                layer.confirm('确认删除？', {
                    ...
                    var url = "/admin.php/Rewardopt/delete?id=" + id + ".html";
