<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpstudy\WWW\php_web\public/../app/admin\view\index\train_opt.html";i:1561279648;s:60:"D:\phpstudy\WWW\php_web\app\admin\view\common\headerbar.html";i:1561083731;s:58:"D:\phpstudy\WWW\php_web\app\admin\view\common\sidebar.html";i:1561453611;}*/ ?>
<!doctype html>
<html lang="cn">
                ...
                <table class="layui-table" lay-size="sm" style="text-align:center;">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="30%" style="text-align:center;">培训内容</th>
                    ...
                    <tbody>
                        <?php if(is_array($train) || $train instanceof \think\Collection || $train instanceof \think\Paginator): $i = 0; $__LIST__ = $train;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <td><?php echo $item['no']; ?></td>
                            <td><?php echo $item['pid']; ?></td>
                            <td><?php echo $item['name']; ?></td>
                            <td><?php echo $item['begin']; ?></td>
                            <td><?php echo $item['end']; ?></td>
                            <td><?php echo $item['content']; ?></td>
                            <td>
                                <button class="layui-btn layui-btn-sm layui-btn-danger"
                                    onclick="confirm('<?php echo $item['no']; ?>')">删除
                                </button>
                            </td>
                        </tr>
        ...
        function confirm(id) {
            ...
            layui.use('layer', function () {
                ...
                layer.confirm('确认删除？', {
                    ...
                    var url = "/admin.php/Trainopt/delete?id=" + id + ".html";
