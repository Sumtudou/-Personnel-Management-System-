<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\phpstudy\WWW\php_web\public/../app/index\view\index\edit.html";i:1560162366;s:55:"D:\phpstudy\WWW\php_web\app\index\view\common\main.html";i:1560162736;}*/ ?>
<html>
<head>
  <meta charset="UTF-8">
  <title>创作咯</title>
  ...
  <div class="layui-layout layui-layout-admin">
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item" style="width:40%">
            ...
            <div class="layui-input-block">
                <input type="text" id="img" placeholder="请输入地址" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div id="uedit">
            <h1><br /> </h1>
            <div id="editor" type="text/plain" style="width:95%;height:500px;"></div>
        </div>
