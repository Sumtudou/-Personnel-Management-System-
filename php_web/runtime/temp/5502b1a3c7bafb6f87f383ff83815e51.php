<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\phpstudy\WWW\php_web\public/../app/admin\view\index\depart_modify.html";i:1561427386;s:60:"D:\phpstudy\WWW\php_web\app\admin\view\common\headerbar.html";i:1561083731;s:58:"D:\phpstudy\WWW\php_web\app\admin\view\common\sidebar.html";i:1561453611;}*/ ?>
<!doctype html>
<html lang="cn">
                    ...
                    <form class="layui-form" action="">
                        <div class="layui-form-item" style="width:40%">
                            ...
                            <div class="layui-input-block">
                                ...
                                disabled="disabled"  autocomplete="off" class="layui-input" value="<?php echo $departid; ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item" style="width:40%">
                            ...
                            <div class="layui-input-block">
                                <input type="text" id="departname" class=" input-xlarge" required lay-verify="required"
                                  autocomplete="off" class="layui-input" value="<?php echo $dname; ?>">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item" style="width:40%">
                            ...
                            <div class="layui-input-block">
                               ...
                               disabled="disabled" value="<?php echo $departsum; ?>" autocomplete="off" class="layui-input"> 
                            </div>
                        </div>
                        <div class="layui-form-item" style="width:40%">
                            ...
                            <div class="layui-input-block">
                                ...
                                disabled="disabled"   value="<?php echo $manager; ?>"   autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item" style="width:40%">
                            ...
                            <div class="layui-input-block">
                                ...
                                disabled="disabled"   value="<?php echo $pid; ?>"    autocomplete="off" class="layui-input">
                            </div>
                        </div>
