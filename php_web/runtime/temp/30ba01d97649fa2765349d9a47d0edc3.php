<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpstudy\WWW\php_web\public/../app/admin\view\index\staff_opt.html";i:1561273716;s:60:"D:\phpstudy\WWW\php_web\app\admin\view\common\headerbar.html";i:1561083731;s:58:"D:\phpstudy\WWW\php_web\app\admin\view\common\sidebar.html";i:1561453611;}*/ ?>
<!doctype html>
<html lang="cn">
        ...
        <section id="main" class="column">
            <article class="module width_full">
                ...
                <div class="module_content">
                    <form class="form-search" action="/admin.php/Staffopt/query" method="post">
                        ...
                        <a href="/admin.php/Staffopt/queryall"><input type="button" class="btn" value="查询全部员工" /></a>
                    </form>
                </div>
            </article>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="layui-btn layui-btn-sm layui-btn-danger"
                                    onclick="confirm('<?php echo $item['pid']; ?>')">开除
                                </button>
                            </td>
                        </tr>
        ...
        function confirm(id) {
            ...
            layui.use('layer', function () {
                ...
                layer.confirm('确认开除？', {
                    ...
                    var url = "/admin.php/Staffopt/delete?id=" + id + ".html";
