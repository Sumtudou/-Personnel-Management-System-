<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpstudy\WWW\php_web\public/../app/admin\view\index\job_modify_display.html";i:1561548077;}*/ ?>
<!doctype html>
<html>
    ...
    <div class="main" style="margin-left: 25%;  width:50%">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="pid" required lay-verify="required" autocomplete="off" value=<?php echo $pid; ?>
        ...
        <form class="layui-form" action="" lay-filter="test">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="name" value="<?php echo $pname; ?>" required lay-verify="required" autocomplete="off"
                         class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="money" required lay-verify="required" autocomplete="off" value=<?php echo $money; ?>
                        disabled="disabled" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="depart" required lay-verify="required" autocomplete="off" value=<?php echo $departname; ?>
                        disabled="disabled" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="job" required lay-verify="required" autocomplete="off" value=<?php echo $job; ?>
                        disabled="disabled" class="layui-input">
                </div>
            </div>
